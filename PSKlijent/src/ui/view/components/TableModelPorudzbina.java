 ...
 * @author Luka
 */
public class TableModelPorudzbina extends AbstractTableModel{

    boolean editable;
    List<Porudzbina> porudzbine;
    String[] columnNames=new String[]{"ID", "Naziv", "Cena", "Restoran", "Vreme porucivanja"};
    
    public TableModelPorudzbina(List<Porudzbina> porudzbine){
    ...
    public Object getValueAt(int x, int y) {
        ...
        switch(y){
            ...
            case 3: return porudzbina.getKorisnikR().getNazivKorisnika();
    ...
    public void removeOrder(Porudzbina p){
        porudzbine.remove(p);
        fireTableDataChanged();;
    }

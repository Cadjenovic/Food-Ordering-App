 ...
 * @author Luka
 */
public class TableModelPonudaKorisnik extends AbstractTableModel{

    boolean editable;
    List<Ponuda> ponude;
    String[] columnNames=new String[]{"Naziv", "Cena"};
    
    public TableModelPonudaKorisnik(List<Ponuda> ponude){
        this.ponude = ponude;
    }
    ...
    public Object getValueAt(int x, int y) {
        ...
        switch(y){
            case 0: return ponuda.getPonudaNaziv();
            case 1: return ponuda.getPonudaCena();
            default: return "n/a";
        }
    }
